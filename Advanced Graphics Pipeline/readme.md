...
- Check out the **API Info** section of your Pop and copy'n paste the `endboint` and `Auth Token` into `config.js` of your local copy of this repo.
...
Start your local server from the **_root directory_** of the project!
